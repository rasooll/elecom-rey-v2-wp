<div class="row">
		<div class="col-lg-7 col-md-7 col-sm-12 hidden-xs"> <!-- Slide Show -->
			...
			<div id="news">
				...
				<div id="news-content">
					<div id="sidebar"><ul>
						...
						<?php $paged = (get_query_var('paged')) ? get_query_var('paged') : 1;     query_posts('showposts=' . 5 . '&paged=' . $paged . '&category_name=' . "news");?>         <?php while ( have_posts() ) : the_post(); ?>
